@section('footer')
    ...
    <footer class="d-md-none d-md-block sticky-bottom">
        <ul class="nav">
            <li class="nav-item border bg-white text-center rounded-start">
            ...
            <li class="nav-item border bg-white text-center">
            ...
            <li class="bg-white nav-item border text-center">
            ...
            <li class="bg-white nav-item border rounded-end text-center">
